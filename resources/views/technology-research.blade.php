        ...
        <div class="container">
            ...
            <ul class="row g-0 nav nav-tabs">
                <li class="nav-item col-md-6" role="presentation">
                    <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#innovation-tab" type="button" role="tab" aria-controls="innovation-tab" aria-selected="true">HYPERAS chain Innovation</button>
                </li>
                <li class="nav-item col-md-6" role="presentation">
            ...
            <div class="tab-content">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <a href="#" class="item">
                                ...
                                <h6>HYPERAS CHAIN 2021 Performance</h6>
                            </a>
                        </div>
                        <div class="col-md-4">
                            <a href="#" class="item">
                                <p><img src="{{ asset('img/img-1.jpg') }}" class="w-100"></p>
                                <h6>A Proposal for Decentralizing HYPERAS chain Governance</h6>
                            </a>
                        </div>
                        <div class="col-md-4">
                            <a href="#" class="item">
                                <p><img src="{{ asset('img/img-1.jpg') }}" class="w-100"></p>
                                <h6>HYPERAS chain's Approach to the Right to Be Forgotten</h6>
                            </a>
                        </div>
                        <div class="col-md-4">
                            <a href="#" class="item">
                ...
                <div class="tab-pane fade" id="research-tab" role="tabpanel" aria-labelledby="research-tab">
                    <div class="item">
                        ...
                        <div>HYPERAS chain: A secure and efficient distributed ledger</div>
                        <div class="mb-3">By <a href="#" class="textPink">J. Chen and S. Micali</a></div>
                        <div>Theoretical Computer Science, 777:155-183, 2019</div>
                        <div><a href="#" class="textPink">https://www.HYPERAS chain.io/HYPERAS chain/article/pii/S030439751930091X</a></div>
                    </div>
                    <div class="item">
                        <h6 class="title text-uppercase">Journals and Peer-reviewed Conferences</h6>
                        <div>HYPERAS chain: A secure and efficient distributed ledger</div>
